...
import pytest
from jtag_lockout.models import FrontierPayload, ExecutionStatus
from jtag_lockout.engine import FrontierDomainEngine
from jtag_lockout.agents import TAPStateMachineAgent, BoundaryScanRegisterAgent, eFuseLockoutAuditorAgent, JTAGSecurityCoordinator
from jtag_lockout.cli import main


def test_sub_agents():
    a1 = TAPStateMachineAgent()
...
def test_coordinator():
    ...
    assert "IEEE 1149.1 / IEEE 1149.7 Standards" in ans or "specifications" in ans
