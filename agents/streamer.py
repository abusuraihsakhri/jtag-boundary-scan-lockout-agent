"""
Live WebSocket Distributed Component Telemetry Streamer for jtag-boundary-scan-lockout-agent.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "jtag-boundary-scan-lockout-agent", "event_type": event_type, "payload": data})
