...
class AuditTrail:
    ...
    def __init__(self, secret_key: Optional[str] = None):
        ...
        if not resolved_key:
            ...
            warnings.warn(
                "AUDIT_SECRET_KEY not set — using an ephemeral randomly generated key. "
                "Set the AUDIT_SECRET_KEY environment variable for persistent audit integrity across restarts.",
                RuntimeWarning,
                stacklevel=2,
            )
